...
Our Code of Conduct helps facilitate a positive interaction environment for everyone involved with the team, and provides guidance on what to do if you experience problematic behavior. Read more in our [Code of Conduct](https://github.com/pixlise/.github/blob/main/CODE_OF_CONDUCT.md), and make sure you agree to its terms. 

### Developer Environment

For more detailed guides, see our each of our developer areas in our [main docs site]() for more details on how to set up your local environment, to best contribute to our project. 
...
- [fixme]
- Located within the repository: [fixme]
...
- Be polite and friendly. See our [Code of Conduct](https://github.com/pixlise/.github/blob/main/CODE_OF_CONDUCT.md) recommendations as you interact with others in the team.
